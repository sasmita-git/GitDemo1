...
public class ProctoredAssessmentTest_RNMH2013 extends BaseTest {
	...
	public void NewATI60_ProctoredAssessmentTest_RNMH2013() throws Exception {
		log(logger, "NewATI60_ProctoredAssessmentTest_RNMH2013 Start");
		...
		proctorChromePage.enteringProctIdAndPwd(proctorDriver,
				PropertiesRepository.getString("id.proctor.id.value.prod.rnmh2010"),
				PropertiesRepository.getString("id.proctor.pwd.value.prod.rnmh2010"));//Thread.sleep(10000);Thread.sleep(10000);
		proctorChromePage.waitUntillLoadingImageIsDisappeared(proctorDriver, PropertiesRepository.getString("ATIFaculti.common.page.spinner.loc"));
		...
		proctoredAssessmentPage.enterTextValue(PropertiesRepository.getString("new-atitesting.add.product.id.new.loc"), PropertiesRepository
				.getString("id.proctor.id.value.prod.rnmh2010"));
		...
		*/
		...
		// Student End		
		log(logger, "NewATI60_ProctoredAssessmentTest_RNMH2013 End");		
	}	
