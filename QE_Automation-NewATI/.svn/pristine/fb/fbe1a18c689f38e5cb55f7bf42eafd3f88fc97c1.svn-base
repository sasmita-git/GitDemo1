...
public class PulseUserSmokeTest3 extends BaseTest {
...
//pulse user with my result page validation --new test case
	@TestAnnotations(testID="NewATI-847")
	@Test(priority = 1, alwaysRun = true, enabled = true, groups = {"Smoke"}, description = "NewATI-847:Verify result functionality for exiting non pulse user.")
	
	public void NewATI847_VerifyResultFunctionalityForExitingNonpulseUser() throws Exception {
	log(logger, "NewATI847_VerifyResultFunctionalityForExitingNonpulseUser Starts ");
...
//	VerificationHandler.verifyTrue(helpPage.verifyFAQSectionHeaders());
	...
	log(logger, "NewATI847_VerifyResultFunctionalityForExitingNonpulseUser End");
