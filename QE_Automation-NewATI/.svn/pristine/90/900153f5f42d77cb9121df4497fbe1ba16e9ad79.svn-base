...
public class ProctoredAssessmentTest2 extends BaseTest {
	 ...
	 * @throws Exception
	 */
	@Test(priority = 1, alwaysRun = true, enabled = true, groups = {"Regression", "Smoke"}, description = "NewATI-50:Proctor assessment feature")
	public void NewATI50_ProctoredAssessmentTest() throws Exception {
		log(logger, "NewATI50_ProctoredAssessmentTest Start");
		...
		// Student End		
		log(logger, "NewATI50_ProctoredAssessmentTest End");		
	}	
