...
public class ProctoredAssessmentTest_RNComprehensivePredictor2010 extends BaseTest {
	 ...
	 * @throws Exception
	 */
	@TestAnnotations(testID = "NewATI-931")
	@Test(priority = 1, alwaysRun = true, enabled = true, groups = {"Regression", "Smoke"}, description = "NewATI-931:RN Comprehensive Predictor 2016")
	public void NewATI931_ProctoredAssessmentTest_RNCP2010() throws Exception {
		log(logger, "NewATI931_ProctoredAssessmentTest_RNCP2010 Start");
		...
		proctorChromePage.verifyAndClick(proctorDriver, PropertiesRepository.getString("id.home.page.left.navigator.icon.link"), true);
		proctorChromePage.waitUntillLoadingImageIsDisappeared(proctorDriver, PropertiesRepository.getString("ATIFaculti.common.page.spinner.loc"));
		proctorChromePage.waitUntillLoadingImageIsDisappeared(proctorDriver, PropertiesRepository.getString("ATIFaculti.common.page.spinner.loc"));
		Thread.sleep(20000);
		...
		proctorChromePage.enteringProctIdAndPwd(proctorDriver,
				PropertiesRepository.getString("id.proctor.id.value.prod.rncp2010"),
				PropertiesRepository.getString("id.proctor.pwd.value.prod.rncp2010"));//Thread.sleep(10000);Thread.sleep(10000);
		proctorChromePage.waitUntillLoadingImageIsDisappeared(proctorDriver, PropertiesRepository.getString("ATIFaculti.common.page.spinner.loc"));
		...
		proctoredAssessmentPage.enterTextValue(PropertiesRepository.getString("new-atitesting.add.product.id.new.loc"), PropertiesRepository
				.getString("id.proctor.id.value.prod.rncp2010"));
		...
		boolean resultFlag = proctorPage.takeTEASProctorAssessmentContinue_RNL2013();
		...
		*/
		...
		// Student End		
		log(logger, "NewATI931_ProctoredAssessmentTest_RNCP2010 End");		
	}	
