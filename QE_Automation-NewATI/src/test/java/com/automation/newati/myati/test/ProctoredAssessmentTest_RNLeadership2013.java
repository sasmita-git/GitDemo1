...
public class ProctoredAssessmentTest_RNLeadership2013 extends BaseTest {
	...
	public void NewATI60_ProctoredAssessmentTest_RNL2013() throws Exception {
		log(logger, "NewATI60_ProctoredAssessmentTest_RNL2013 Start");
		...
		proctorChromePage.enteringProctIdAndPwd(proctorDriver,
				PropertiesRepository.getString("id.proctor.id.value.prod.rnl2013"),
				PropertiesRepository.getString("id.proctor.pwd.value.prod.rnl2013"));//Thread.sleep(10000);Thread.sleep(10000);
		proctorChromePage.waitUntillLoadingImageIsDisappeared(proctorDriver, PropertiesRepository.getString("ATIFaculti.common.page.spinner.loc"));
		...
		proctoredAssessmentPage.enterTextValue(PropertiesRepository.getString("new-atitesting.add.product.id.new.loc"), PropertiesRepository
				.getString("id.proctor.id.value.prod.rnl2013"));
		...
		*/
		...
		// Student End		
		log(logger, "NewATI60_ProctoredAssessmentTest_RNL2013 End");		
	}	
