...
public class ProctoredAssessmentTest_CTA extends BaseTest {
	...
	public void NewATI60_ProctoredAssessmentTest_CTA() throws Exception {
		log(logger, "NewATI60_ProctoredAssessmentTest_CTA Start");
		...
		String userName = "AutoUser09032018855";
		...
		proctorChromePage.loginToApplicationID(proctorDriver,
				PropertiesRepository.getString("id.login.proctor.cta.2013.username"),
				PropertiesRepository.getString("id.login.proctor.cta.2013.password"));
		...
		proctorChromePage.enteringProctIdAndPwd(proctorDriver,
				PropertiesRepository.getString("id.proctor.id.value.prod.cta"),
				PropertiesRepository.getString("id.proctor.pwd.value.prod.cta"));//Thread.sleep(10000);Thread.sleep(10000);
		proctorChromePage.waitUntillLoadingImageIsDisappeared(proctorDriver, PropertiesRepository.getString("ATIFaculti.common.page.spinner.loc"));
		...
		proctoredAssessmentPage.clickButton(".add-product-btn.focus-element-flag");
		...
		proctoredAssessmentPage.enterTextValue(PropertiesRepository.getString("new-atitesting.add.product.id.new.loc"), PropertiesRepository
				.getString("id.proctor.id.value.prod.cta"));
		...
		boolean resultFlag = proctorPage.takeTEASProctorAssessmentContinue_CTA();
		...
		// Student End		
		log(logger, "NewATI60_ProctoredAssessmentTest_CTA End");		
	}	
