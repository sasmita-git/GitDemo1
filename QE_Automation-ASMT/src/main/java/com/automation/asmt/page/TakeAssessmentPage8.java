...
public class TakeAssessmentPage8 extends TakeAssessmentPage9 {

	private Logger logger = LogManager.getLogger(this.getClass());
	
	public TakeAssessmentPage8(WebDriver webDriver) {
		super(webDriver);
	}
	 ...
	 * @throws Exception
	 */
	public boolean takeTestCompletePostAssessmentSurvey(boolean bool, boolean breakFlag,
			boolean rationaleFlag, boolean flagquestion) throws Exception {
		logger.info("Method : takeTestCompletePostAssessmentSurvey :::::::: Starts");
		boolean flag = false;
		...
		try {
			...
			for (int i = 0; i <= count; i++) {
				...
				if (i == count) {
					...
					boolLastSection = completePostAssessmentSurveySection(rationaleFlag, flagquestion,"Complete Post Assessment Survey");
					if(boolLastSection) {
						logger.info("Post Assessment Survey Message is verified.");
						flag = true;
					}
				} else {
					if (i == 0 && flagquestion) {
		...
		logger.info("Method : takeTestCompletePostAssessmentSurvey :::::::: END flag --> " + flag);
		return flag;
	}
	 ...
	 * @throws Exception
	 */
	public boolean takeTestVerifyCompletionPopup(boolean bool, boolean breakFlag,
			boolean rationaleFlag, boolean flagquestion) throws Exception {
		logger.info("Method : takeTestVerifyCompletionPopup :::::::: Starts");
		boolean flag = false;
		boolean boolLastSection = false;
		try {
			...
			for (int i = 0; i <= count; i++) {
				...
				if (i == count) {
					...
					boolLastSection = takeAssessmentVerifySection(rationaleFlag, flagquestion,"Complete Post Assessment Survey");
					if(boolLastSection) {
						logger.info("Post Assessment Survey Message is verified.");
						flag = true;
					}
		...
		waitUntillBufferInvisible(PropertiesRepository
				.getString("asmt.pleasewait.bufferLoc"));
		logger.info("Method : takeTestVerifyCompletionPopup :::::::: END flag --> " + flag);
		return flag;
	}
	 ...
	 * @throws Exception
	 */
	public boolean takeTestFlagAllQuestion(boolean bool, boolean breakFlag,
			boolean rationaleFlag, boolean flagquestion) throws Exception {
		logger.info("Method : takeTestFlagAllQuestion :::::::: Starts");
		boolean flag = false;
		try {
			...
			for (int i = 0; i <= count; i++) {
				...
				if (i == count) {
					...
					boolean boolFinalSection = takeAssessmentVerifySection(rationaleFlag, flagquestion, "Complete Post Assessment Survey");
					if(boolFinalSection) {
						logger.info("Flagged all question and clicked on Complete Post Assessment Survey button");
						flag = true;
					}
				} else {
					if (i == 0 && flagquestion) {
			...
			logger.info("unable to take practice assessment in takeTestFlagAllQuestion" + e);
		}
		waitUntillBufferInvisible(PropertiesRepository
				.getString("asmt.pleasewait.bufferLoc"));
		logger.info("Method : takeTestFlagAllQuestion :::::::: END");
		return flag;
	}
}
