...
public class VerificationHandler {
	...
	public static void verifyEquals(float actual, float control,
			String message) {
		try {
			Assert.assertEquals(actual, control, message);
		} catch (AssertionError e) {
	...
	public static void verifyNotEquals(float actual, float control,
			String message) {
		try {
			Assert.assertNotEquals(actual, control, message);
		} catch (AssertionError e) {
	...
	public static void verifyEquals(long actual, long control,
			String message) {
		try {
			Assert.assertEquals(actual, control, message);
		} catch (AssertionError e) {
	...
	public static void verifyNotEquals(long actual, long control,
			String message) {
		try {
			Assert.assertNotEquals(actual, control, message);
		} catch (AssertionError e) {
	...
	public static void verifyEquals(double actual, double control,
			String message) {
		try {
			Assert.assertEquals(actual, control, message);
		} catch (AssertionError e) {
	...
	public static void verifyNotEquals(double actual, double control,
			String message) {
		try {
			Assert.assertNotEquals(actual, control, message);
		} catch (AssertionError e) {
